...
src/%.o: ../src/%.cpp
	...
	arm-none-eabi-g++ -mcpu=cortex-m4 -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -DF_CPU=48000000 -D__MK20DX256__ -DUSB_SERIAL -DLAYOUT_US_ENGLISH -I"F:\kalkulyator-workspace-v2\TeensyCore3\src" -std=gnu++11 -fabi-version=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
...
src/%.o: ../src/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross ARM C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -DF_CPU=48000000 -D__MK20DX256__ -DUSB_SERIAL -DLAYOUT_US_ENGLISH -I"F:\kalkulyator-workspace-v2\TeensyCore3\src" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
